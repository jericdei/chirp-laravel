...
return [
	...
	*/
    ...
    'stubs' => [
        'composer.json' => 'stubs/modules/composer.stub',
        'resources/js/pages/index.tsx' => 'stubs/modules/page.stub',
        'routes/StubModuleName-routes.php' => 'stubs/modules/route.stub',
        'src/Providers/StubClassNamePrefixServiceProvider.php' => 'stubs/modules/service-provider.stub',
        'src/Http/Controllers/StubClassNamePrefixController.php' => 'stubs/modules/controller.stub',
        'database/migrations/StubMigrationPrefix_create_StubModuleNamePlural_table.php' => 'stubs/modules/migration.stub',
        'src/Models/StubClassNamePrefix.php' => 'stubs/modules/model.stub',
    ],
